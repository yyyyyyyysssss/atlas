...
public class ThirdPartyAuthenticationToken extends AbstractAuthenticationToken {
    ...
    public static ThirdPartyAuthenticationToken unauthenticated(Object principal, Object credentials) {
        return new ThirdPartyAuthenticationToken(principal, credentials);
    }

    public static ThirdPartyAuthenticationToken authenticated(Object principal, Object credentials, Collection<? extends GrantedAuthority> authorities) {
        return new ThirdPartyAuthenticationToken(principal, credentials, authorities);
    }
    ...
    @JsonDeserialize(using = ThirdPartyAuthenticationTokenDeserializer.class)
    @JsonAutoDetect(
            fieldVisibility = JsonAutoDetect.Visibility.ANY,
            getterVisibility = JsonAutoDetect.Visibility.NONE,
            isGetterVisibility = JsonAutoDetect.Visibility.NONE)
    @JsonIgnoreProperties(ignoreUnknown = true)
    public abstract static class ThirdPartyAuthenticationTokenMixin {
    }

    static class ThirdPartyAuthenticationTokenDeserializer extends JsonDeserializer<ThirdPartyAuthenticationToken>{
        ...
        @Override
        public ThirdPartyAuthenticationToken deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
            ...
            ThirdPartyAuthenticationToken token = !authenticated ? ThirdPartyAuthenticationToken.unauthenticated(principal, credentials) : ThirdPartyAuthenticationToken.authenticated(principal, credentials, authorities);
