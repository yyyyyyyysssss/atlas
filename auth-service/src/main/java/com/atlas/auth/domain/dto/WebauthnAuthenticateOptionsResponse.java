...
public record WebauthnAuthenticateOptionsResponse(
    ...
    public static WebauthnAuthenticateOptionsResponse of(PublicKeyCredentialRequestOptions source) {

        return new WebauthnAuthenticateOptionsResponse(
                ...
                source.getAllowCredentials()
                        .stream()
                        .map(it -> new WebauthnAuthenticateOptionsResponse.AllowCredential(
                                it.getType().getValue(),
