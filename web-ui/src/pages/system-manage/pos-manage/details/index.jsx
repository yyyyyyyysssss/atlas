    ...
    return (
        ...
        >
            ...
            >
                ...
                <Space>
                    <Button className="min-w-[88px]" type="primary" onClick={handleSearch} loading={getPositionDataLoading}>{t('查询')}</Button>
                    <Button className="min-w-[88px]" onClick={handleReset} loading={getPositionDataLoading}>{t('重置')}</Button>
                </Space>
            </Flex>
            <SmartTable
                className='w-full'
